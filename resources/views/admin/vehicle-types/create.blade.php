        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="bg-white relative shadow-md rounded-lg space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="flex items-center px-4 py-2">
                    <h5 class="text-gray-800 font-semibold">Tambah Tipe Kendaraan</h5>
                </div>
                    ...
                    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-2 md:gap-6">
                        <div>
                            ...
                            <input type="text" name="key" id="key"
                                ...
                                placeholder="Contoh: car" value="{{ old('key') }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5"
                                placeholder="Contoh: Mobil" value="{{ old('name') }}" required>
