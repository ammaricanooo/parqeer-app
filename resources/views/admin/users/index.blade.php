                                ...
                                <tr class="border-b hover:bg-gray-100">
                                    <td scope="row"
                                        ...
                                        <div class="flex items-center mr-3 min-w-16 max-w-16">
                                            ...
                                            @else
                                            <img src="https://telegra.ph/file/24fa902ead26340f3df2c.png" alt="{{ $user->name }}">
                                            @endif
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">
                                        <div class="flex items-centers max-w-sm lg:max-w-2xl">
                                            <p class="text-ellipsis overflow-hidden">{{ $user->role }}</p>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">
                                        <div class="flex items-centers max-w-sm lg:max-w-2xl">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <form id="user-destroy-{{ $user->id }}" action="{{ route('admin.users.destroy', $user->id) }}" method="post">
                                                @method('delete')
                                                @csrf
                                                <button
