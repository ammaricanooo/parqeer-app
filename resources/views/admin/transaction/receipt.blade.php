...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .amount-section { font-size: 14px; font-weight: bold; }
        ...
        .status-paid { text-align: center; background: #90EE90; color: #000; padding: 10px; margin: 10px 0; font-weight: bold; border-radius: 3px; }
        .status-pending { text-align: center; background: #FFD700; color: #000; padding: 10px; margin: 10px 0; font-weight: bold; border-radius: 3px; }
