    ...
    <div class="py-12 bg-gray-50  min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div
                ...
                <div
                    class="flex flex-col md:flex-row md:items-center justify-between p-5 bg-white  border-b border-gray-100  gap-4">
                    <div>
                    ...
                    <div class="flex items-center gap-3">
                        <form action="{{ route('attendant.transaction.index') }}" class="relative group">
                            <input type="text" name="search" value="{{ request('search') }}"
                                ...
                                class="w-full md:w-64 pl-10 pr-4 py-2 bg-gray-50  border border-gray-300  rounded-lg text-sm focus:ring-2 focus:ring-primary transition-all">
                ...
                @if ($pendingPaymentTransactions->count())
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left border-collapse">
                            <thead
                                class="bg-gray-50  text-gray-600  uppercase text-[11px] font-bold tracking-wider">
                                <tr>
                            ...
                            <tbody class="divide-y divide-gray-100 ">
                                @foreach ($pendingPaymentTransactions as $transaction)
                                    ...
                                    <tr class="hover:bg-gray-50 /30 transition-colors group">
                                        ...
                                        <td class="px-6 py-4">
                                            <span
                                                class="px-3 py-1.5 bg-gray-800 text-white   font-mono font-black rounded border-2 border-gray-700 text-base shadow-sm text-nowrap">
                                        ...
                                        <td
                                            class="px-6 py-4 text-center font-mono font-bold text-primary ">
            ...
            <div
                class="bg-white  shadow-sm rounded-xl overflow-hidden border border-gray-200  opacity-90 hover:opacity-100 transition-opacity">
                <div class="p-5 border-b border-gray-100  bg-gray-50/50 /50">
                    <h2 class="text-lg font-bold text-gray-600  flex items-center italic">
                    ...
                    <table class="w-full text-xs text-left">
                        ...
                        <tbody class="divide-y divide-gray-50 ">
                            @forelse ($completedTransactions as $transaction)
                                ...
                                <tr
                                    class="text-gray-500  hover:bg-gray-50 /20">
